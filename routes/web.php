...
Route::prefix('jennyhouse')->group(function () {
    Route::middleware('auth')->group(function(){
        ...
        Route::get('order',[PayController::class,'index'])->name('order');
        Route::get('order/pay/{id}',[PayController::class,'pay'])->name('order.pay');
        Route::post('order/delete',[PayController::class,'deleteOrder'])->name('order.delete');
        Route::get('order/{id}/edit',[PayController::class,'editOrder'])->name('order.edits');
        Route::post('order/update',[PayController::class,'updateOrder'])->name('order.updates');
        Route::post('order/paymentProses',[PayController::class,'processPayment'])->name('order.done');
        Route::get('kartu-kredit',[KreditController::class,'index'])->name('kartu.kredit');
        Route::get('kartu-kredit/create',[KreditController::class,'create'])->name('kartu.kredit.create');
        Route::post('kartu-kredit/create',[KreditController::class,'store'])->name('kartu.kredit.store');
        Route::get('kartu-kredit/{id}/edit',[KreditController::class,'edit'])->name('kartu.kredit.edit');
        Route::post('kartu-kredit/update',[KreditController::class,'update'])->name('kartu.kredit.update');
        Route::post('kartu-kredit/destroy/{id}',[KreditController::class,'destroy'])->name('kartu.kredit.destroy');
    });
